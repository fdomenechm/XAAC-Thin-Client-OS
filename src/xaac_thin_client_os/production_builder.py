    ...
    def phase_configure(self) -> None:
        ...
        self._atomic_write(
            ...
            (
                ...
                "chroot \"$mount_root\" update-locale \"LANG=$install_locale\" \"LANGUAGE=$install_language_env\"\n"
                "chroot \"$mount_root\" /bin/sh -c 'DEBIAN_FRONTEND=noninteractive dpkg-reconfigure keyboard-configuration >/dev/null 2>&1'\n"
