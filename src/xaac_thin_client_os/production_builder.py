...
'''
    ...
    def phase_configure(self) -> None:
        ...
        with self._chroot_mounts():
            ...
            self._chroot([
                "/bin/sh", "-ec",
                "install -d -m 0755 /usr/local/libexec/xaac; "
                "rm -f /usr/local/libexec/xaac/xaac-thin-client-network "
                "/usr/local/libexec/xaac/xaac-thin-client-vpn "
                "/usr/local/libexec/xaac/xaac-thin-client-remote; "
                "printf '%s\\n' '#!/bin/sh' 'set -eu' "
                "'export PATH=/usr/sbin:/usr/bin:/sbin:/bin' "
                "'exec /usr/bin/xaac-network-gui \"$@\"' "
                "> /usr/local/libexec/xaac/xaac-thin-client-network; "
                "printf '%s\\n' '#!/bin/sh' 'set -eu' "
                "'export PATH=/usr/sbin:/usr/bin:/sbin:/bin' "
                "'exec /usr/bin/xaac-thin-client-vpn \"$@\"' "
                "> /usr/local/libexec/xaac/xaac-thin-client-vpn; "
                "printf '%s\\n' '#!/bin/sh' 'set -eu' "
                "'export PATH=/usr/sbin:/usr/bin:/sbin:/bin' "
                "'exec /usr/bin/xaac-thinclient \"$@\"' "
                "> /usr/local/libexec/xaac/xaac-thin-client-remote; "
                "chmod 0755 /usr/local/libexec/xaac/xaac-thin-client-network "
                "/usr/local/libexec/xaac/xaac-thin-client-vpn "
                "/usr/local/libexec/xaac/xaac-thin-client-remote; "
                "test -x /usr/local/libexec/xaac/xaac-thin-client-network; "
                "test -x /usr/local/libexec/xaac/xaac-thin-client-vpn; "
                "test -x /usr/local/libexec/xaac/xaac-thin-client-remote; "
                "test ! -L /usr/local/libexec/xaac/xaac-thin-client-network; "
                "test ! -L /usr/local/libexec/xaac/xaac-thin-client-vpn; "
                "test ! -L /usr/local/libexec/xaac/xaac-thin-client-remote",
            ...
            self._chroot([
                ...
                "test -x /usr/bin/xaac-thinclient; test -x /usr/local/libexec/xaac/xaac-thin-client-remote; test ! -L /usr/local/libexec/xaac/xaac-thin-client-remote; "
                ...
                "test -x /usr/bin/xaac-thin-client-vpn; test -x /usr/local/libexec/xaac/xaac-thin-client-vpn; test ! -L /usr/local/libexec/xaac/xaac-thin-client-vpn; "
                ...
                "test -x /usr/bin/xaac-network-gui; test -x /usr/bin/xaac-network-manager; test -x /usr/local/libexec/xaac/xaac-thin-client-network; test ! -L /usr/local/libexec/xaac/xaac-thin-client-network; "
