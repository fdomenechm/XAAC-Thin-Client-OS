...
def test_phase85_policy_serializes_visual_feedback(tmp_path: Path, project_root: Path) -> None:
    ...
    assert payload["visual_session"]["stable_background_color"] == "#596166"
