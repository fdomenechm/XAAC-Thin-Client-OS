...
## Serveis principals
Reviseu `xaac-thin-client`, `xaac-agent`, el servei d’actualització i, quan estiga habilitat, RustDesk. Useu `systemctl status` i `journalctl -u` conservant les evidències necessàries.
